...
# --------------------------------------
#  4: Add `generation_indicator` column
# --------------------------------------
df_transformed = df_transformed.withColumn(
...
# --------------------------------------
#  6: Map signal names using dictionary
# --------------------------------------
